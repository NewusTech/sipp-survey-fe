...
const ImportBridgeSection = () => {
  const apiUrl = import.meta.env.VITE_APP_API_URL;
  const downloadTemplate = "template/jembatan.xlsx";
  const importRuasJembatan = "import/jembatan";
  ...
  return (
    <DialogContent className="h-[300px] w-full md:w-[500px]">
      <DialogHeader>
        <DialogTitle>Import Data Ruas Jembatan</DialogTitle>
      </DialogHeader>
...
export default ImportBridgeSection;
