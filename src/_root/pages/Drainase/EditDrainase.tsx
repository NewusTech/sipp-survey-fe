...
const formSchema = z.object({
  ...
  panjang_ruas: z.string().transform((val) => Number(val)),
  desa_id: z
    .string()
...
const EditDrainase = () => {
  ...
  useEffect(() => {
    document.title = "Ubah Drainase - SIPPP";
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    const formData = {
      ...
      panjang_ruas: values.panjang_ruas,
      desa_id: values.desa_id,
    };

    axios
      .patch(`${apiUrl}/${updateDrainase}/${id}`, formData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
