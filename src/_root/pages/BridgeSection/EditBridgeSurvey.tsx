...
const formSchema = z.object({
  ...
  kecamatan_id: z.string().transform((val) => Number(val)),
...
const EditBridgeSurvey = () => {
  ...
  const updateBridgeSection = "jembatan/update";
  const getData = "jembatan";
  ...
  useEffect(() => {
    if (data) {
      ...
      form.reset({
        ...
        lebar: data.lebar,
        jml_bentang: data.jml_bentang,
        tipe_ba: data.tipe_ba,
        kondisi_ba: data.kondisi_ba,
        tipe_bb: data.tipe_bb,
        kondisi_bb: data.kondisi_bb,
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    axios
      .post(`${apiUrl}/${updateBridgeSection}/${id}`, formData, {
        headers: {
...
export default EditBridgeSurvey;
